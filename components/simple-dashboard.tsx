      ...
      <div className="w-full max-w-7xl mx-auto p-4 space-y-6">
        ...
        <div className="flex items-center justify-between py-6">
          <div>
            ...
            <p className="text-muted-foreground">All QR codes and tracking data</p>
          </div>
                  ...
                  {loading ? (
                    ...
                    qrCodes.map((qr) => (
                      <TableRow key={qr.id}>
                        ...
                        <TableCell>
                          <div className="text-lg font-bold">{qr.totalScans.toLocaleString()}</div>
                        </TableCell>
                        <TableCell>
                          <div className="text-lg font-bold">{qr.uniqueVisitors.toLocaleString()}</div>
                        </TableCell>
                        <TableCell>
                          <div className="flex items-center gap-2">
                            <MapPin className="w-4 h-4" />
                            <div>
                              <div className="font-medium">{qr.topLocation}</div>
                        ...
                        <TableCell>
                          <div className="text-sm">{formatDate(qr.createdAt)}</div>
                        </TableCell>
                        <TableCell>
                          {qr.lastScanAt ? (
